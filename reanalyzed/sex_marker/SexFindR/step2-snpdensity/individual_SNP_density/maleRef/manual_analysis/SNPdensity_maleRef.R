...
library(tidyverse)
library(ggpubr)
setwd("/group/millermrgrp2/shannon/projects/dissertation/reanalyzed/sex_marker/SexFindR/step2-snpdensity/individual_SNP_density/maleRef")
...
table(true_SNPdensity$mean_MvF_dif > 0) #14713
table(true_SNPdensity$mean_MvF_dif < 0) #20553
table(true_SNPdensity$mean_MvF_dif == 0) #8783
...
# save results
setwd("/group/millermrgrp2/shannon/projects/dissertation/reanalyzed/sex_marker/SexFindR/step2-snpdensity/individual_SNP_density/maleRef/manual_analysis")
