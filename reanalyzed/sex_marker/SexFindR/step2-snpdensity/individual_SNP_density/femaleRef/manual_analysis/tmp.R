library(tidyverse)
library(ggpubr)
setwd("/group/millermrgrp2/shannon/projects/dissertation/reanalyzed/sex_marker/SexFindR/step2-snpdensity/individual_SNP_density/femaleRef")
...
table(true_SNPdensity$mean_MvF_dif > 0) #15831
table(true_SNPdensity$mean_MvF_dif < 0) #22225
table(true_SNPdensity$mean_MvF_dif == 0) #4388
...
setwd("/group/millermrgrp2/shannon/projects/dissertation/reanalyzed/sex_marker/SexFindR/step2-snpdensity/individual_SNP_density/femaleRef/manual_analysis")
